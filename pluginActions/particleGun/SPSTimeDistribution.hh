#ifndef SPSTimeDistribution_hh
#define SPSTimeDistribution_hh

/** @file SPSTimeDistribution.hh
...
/** Provides a time distribution to the General Particle Source gun. 
    ...
    SPSTimeDistribution is a modified and updated version of the
    G4SPSEneDistribution included with the distribution of GEANT4,
    details below.  This function allows the GPS and SPS to
