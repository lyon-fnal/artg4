// g2GeneralParticleSource.cc provides the implementations of the modified 
...
gm2::g2GeneralParticleSource::
  g2GeneralParticleSource(fhicl::ParameterSet const & p)
      ...
      _logInfo("GENERALPARTICLESOURCE")
{
  ...
  for (size_t i = 0; i != sourceParams.size(); ++i) {
    ...
    // Create the source
    _currentSource = new g2SingleParticleSource(currParams);
...
// Boring destructor.  
gm2::g2GeneralParticleSource::~g2GeneralParticleSource()
{}
...
void gm2::g2GeneralParticleSource::IntensityNormalization()
{
...
void gm2::g2GeneralParticleSource::GeneratePrimaryVertex(G4Event* evt)
{
  if (!_multiple_vertex){
...
void gm2::g2GeneralParticleSource::AddaSource(double intensity)
{
  _currentSource = new g2SingleParticleSource();
  _sourceVector.push_back(_currentSource);
...
void gm2::g2GeneralParticleSource::ListSource()
{
...
void gm2::g2GeneralParticleSource::SetCurrentSourceto(int aV)
{
  size_t id = size_t (aV) ;
...
void gm2::g2GeneralParticleSource::SetCurrentSourceIntensity(double aV)
{
...
// Remove all sources
void gm2::g2GeneralParticleSource::ClearAll()
{
  _currentSourceIdx = -1;
  _currentSource = 0;
  _sourceVector.clear();
...
void gm2::g2GeneralParticleSource::DeleteaSource(int aV)
{
  size_t id = size_t (aV) ;
