...
gm2::g2SingleParticleSource::
  g2SingleParticleSource(ParameterSet const & p)
{
...
// Boring destructor
gm2::g2SingleParticleSource::~g2SingleParticleSource()
{}
...
// describes.
void gm2::g2SingleParticleSource::setUpPositionDist(ParameterSet const & p)
{
...
void gm2::g2SingleParticleSource::setUpEnergyDist(ParameterSet const & p)
{
...
void gm2::g2SingleParticleSource::setUpTimeDist(ParameterSet const & p)
{
...
void gm2::g2SingleParticleSource::setUpFileImport(ParameterSet const & p)
{
...
void gm2::g2SingleParticleSource::setUpHistos(ParameterSet const & p)
{
  G4cout << "setUpHistos not implemented." << G4endl;
}

void gm2::g2SingleParticleSource::setUpParticleGun(ParameterSet const & p) 
{
...
void gm2::g2SingleParticleSource::GeneratePrimaryVertex(G4Event *evt)
{
...
void gm2::g2SingleParticleSource::UseImportedParticles(G4Event *evt)
{
...
void gm2::g2SingleParticleSource::UseInternallyGenerateParticles(G4Event *evt)
{
  // Generate a position
  particle_position = posGenerator->GenerateOne();
  // Generate a time
...
void gm2::g2SingleParticleSource::SetParticleDefinition
...
void gm2::g2SingleParticleSource::SetVerbosity(int vL)
{
  verbosityLevel = vL;
...
void gm2::g2SingleParticleSource::SetImportFlag(G4bool flag)
{ importFlag = flag; }

// UI function to set the type of particle import file
void gm2::g2SingleParticleSource::SetImportFileType(G4String type)
{ importFileType = type; }

// UI function to set the structure of the particle import file
void gm2::g2SingleParticleSource::SetImportFileStructure(G4String /*type*/)
{
...
void gm2::g2SingleParticleSource::LoadImportFile(G4String fName)
{
...
void gm2::g2SingleParticleSource::ClearImportData()
{ 
