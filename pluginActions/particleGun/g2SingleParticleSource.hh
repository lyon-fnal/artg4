...
// g2SingleParticleSource.hh is a modified and updated version of the
...
// g2SingleParticleSource has a multitude of parameters that determine its 
// behavior. Unlike in the older version of the g-2 simulation (g2MIGTRACE),
...
#include "g2SPSTimeDistribution.hh"
...
namespace gm2 {
  ...
  public:
    ...
    g2SingleParticleSource (fhicl::ParameterSet const & p); 
    ...
    // Called from g2GPS, returns the requested distribution generators
