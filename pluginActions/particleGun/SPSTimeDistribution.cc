...
SPSTimeDistribution::SPSTimeDistribution()
{
...
void SPSTimeDistribution::SetTimeDisType(G4String DisType)
{
  timeDisType = DisType;
}


void SPSTimeDistribution::SetTimeMin(G4double tMin)
{
  timeMin = tMin;
}


void SPSTimeDistribution::SetTimeMax(G4double tMax)
{
  timeMax = tMax;
}


void SPSTimeDistribution::SetTimeMono(G4double tMono)
{
  timeMono = tMono;
}


void SPSTimeDistribution::SetBeamSigmaInT(G4double t)
{
  timeSE = t;
}


void SPSTimeDistribution::SetTimeZero(G4double zero)
{
  timeZero = zero;
}


void SPSTimeDistribution::SetTimeGradient(G4double grad)
{
  timeGrad = grad;
}


void SPSTimeDistribution::SetTimeInterCept(G4double cept)
{
  timeCept = cept;
}


void SPSTimeDistribution::GenerateMonoChronologic()
{
...
void SPSTimeDistribution::GenerateGaussEnergies()
{
...
void SPSTimeDistribution::GenerateLinearEnergies(G4bool bArb = false)
{
  G4double rndm;
...
G4double SPSTimeDistribution::GenerateOne(G4ParticleDefinition* a)
{
